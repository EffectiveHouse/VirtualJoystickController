...
namespace controller
{
	...
	public class AxesMapping
	{
        ...
        public static Axis AXIS_THROTTLE    = MotionEvent.AxisFromString("AXIS_THROTTLE");
        public static Axis AXIS_RUDDER      = MotionEvent.AxisFromString("AXIS_RUDDER");
        ...
        public static int OrdinalValue(Axis axis)
        {
            ...
            else if (axis == AXIS_THROTTLE)
            {
                return 12;
            }
            else if (axis == AXIS_RUDDER)
            {
                return 13;
            }
            else
